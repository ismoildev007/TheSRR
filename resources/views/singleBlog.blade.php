...
<x-layouts.main>
    ...
    <div class="container">
        <div class="row my-4 my-lg-5">
            <div class="col-md-6 owl-carousel owl-theme default-carousel absolute-dots inside-text-carousel nav-0 mb-3">
                <div class="image-container rotateOut-effect">
                    <span>
                        <img src="{{ asset('storage/' . $blogs->image) }}" alt="" class="w-100">
                    </span>
                </div>
                <div class="image-container rotateOut-effect">
                    <span>
            ...
            <div class="col-md-6">
                <h2 class="fables-second-text-color font-20 semi-font my-3 mt-md-0">{{ $blogs['title_' . $lang] }}</h2>
                <b class="fables-forth-text-color font-14">
                    {!! $blogs['text_' . $lang] !!}
                </b>
            </div>
        </div>
