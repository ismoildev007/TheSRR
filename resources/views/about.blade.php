...
<x-layouts.main>
            ...
            <div class="row overflow-hidden">
                <div class="col-12 col-md-6">
                    <div class="image-container translate-effect-right">
                        <img src="{{ asset('storage/' . $a->image) }}" alt="Fables Template" class="img-fluid">
                    </div>
                </div>
                <div class="col-12 col-md-6 mt-4 mt-md-0">
                    <h2 class="font-30 font-weight-bold fables-second-text-color my-4 d-inline-block d-lg-block wow fadeInRight" data-wow-duration="1.5s">
                        {{ $a['title_' . $lang] }}</h2>
            ...
            <div class="row">
                <div class="col-6 col-md-3">
                    <div class="fables-counter">
                        <h2 class="fables-counter-value font-40 font-weight-bold mb-3 text-white border fables-second-border-color d-inline-block px-4 py-2 mb-4" data-count="01">0</h2>
                        <h3 class="font-14 semi-font text-white">{{ __('app.prinsip1') }}</h3>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="fables-counter">
                        <h2 class="fables-counter-value font-40 font-weight-bold mb-3 text-white border fables-second-border-color d-inline-block px-4 py-2 mb-4" data-count="02">0</h2>
                        <h3 class="font-14 semi-font text-white">{{ __('app.prinsip2') }}</h3>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="fables-counter">
                        <h2 class="fables-counter-value font-40 font-weight-bold mb-3 text-white border fables-second-border-color d-inline-block px-4 py-2 mb-4" data-count="03">0</h2>
                        <h3 class="font-14 semi-font text-white">{{ __('app.prinsip3') }}</h3>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="fables-counter">
                        <h2 class="fables-counter-value font-40 font-weight-bold mb-3 text-white border fables-second-border-color d-inline-block px-4 py-2 mb-4" data-count="04">0</h2>
                        <h3 class="font-14 semi-font text-white">{{ __('app.prinsip4') }}</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row overflow-hidden">
                <div class="col-12 col-md-6">
                    ...
                    <h2 class="font-30 font-weight-bold fables-second-text-color my-4 wow fadeInLeft d-inline d-lg-block" data-wow-duration="1.5s">{{ $a1['title_' . $lang] }}</h2>
                    <div class="fables-forth-text-color mt-4 wow fadeInLeft" data-wow-duration="1.5s">
                        {!! $a1['description_' . $lang] !!}
                    </div>
                </div>
                <div class="col-12 col-md-6 mt-4 mt-md-0">
                    <div class="image-container translate-effect-right">
                        <img src="{{ asset('storage/' . $a1->image) }}" alt="Fables Template" class="img-fluid">
                    </div>
    ...
    <div class="fables-testimonial fables-after-overlay py-4 py-lg-5 bg-rules mt-3">
        <div class="container">
