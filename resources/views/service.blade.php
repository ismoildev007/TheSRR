...
<x-layouts.main>
                ...
                <div class="col-md-10 col-lg-7 mr-auto index-carousel">
                    <div class="owl-carousel owl-theme default-carousel nav-0 z-index mt-md-4 mt-xl-5 pt-md-4 pt-xl-5 dots-0 pb-md-5">
                        <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".4s">
                            ...
                            <a href="/portfolio" class="btn fables-second-background-color fables-second-border-color white-color rounded-0 mr-4 px-3 px-md-4 py-2 bg-hover-transparent fables-second-hover-color">{{ __('app.portfolio') }}</a>
                        </div>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('app.service') }}</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container py-4 py-lg-5">
        <div class="fables-team my-3">
            <h3 class="fables-second-text-color mb-4 mb-lg-5 font-weight-bold"> {{ __('app.our_service') }} </h3>
            <div class="row mb-0 my-lg-5">
                @foreach($services as $service)
                    <div class="col-12 col-sm-4 p-sm-0 mb-4 mb-md-0 wow fadeIn" data-wow-delay=".4s">
                        <div class="img-contain image-container zoomIn-effect">
                            <a href="">
                                <img src="{{ asset('storage/' . $service->image) }}" alt="" class="w-100">
                            </a>
                            <div class="fables-blog-details-overlay fables-main-gradient p-3 d-flex flex-column  align-items-start justify-content-end">
                                <h2 class="font-16 semi-font mt-6 d-sm-none d-md-block"><span class="white-color fables-second-hover-color">{{ $service['title_' . $lang] }}</span></h2>
                                <b class="font-14 fables-third-text-color my-2" style="color: white !important;">
