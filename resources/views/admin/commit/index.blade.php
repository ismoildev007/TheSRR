...
<x-layouts.admin>
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                <div>
                    <a class="btn btn-primary" href="{{ route('commit.create') }}">Create</a>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="mx-1 d-inline-block">
                                                <a href="{{ route('commit.edit', $info->id) }}"><i class="mdi mdi-book-edit-outline fs-3"></i></a>
                                            </div>
                                            <div class="mx-1 d-inline-block">
                                                <a href="{{ route('commit.show', $info->id) }}"><i class="mdi mdi-eye fs-3"></i></a>
                                            </div>
                                            <div class="mx-1 d-inline-block">
                                                <form action="{{ route('commit.destroy', $info->id) }}" method="POST" onsubmit="return confirm('Ochirishga ruxsat berasizmi')">
                                                    @csrf
                                                    @method('DELETE')
