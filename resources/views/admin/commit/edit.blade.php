    ...
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="py-3 py-lg-4">
                <div class="row">
                    <div class="col-lg-6">
                        <h4 class="page-title mb-0">PortfCommitolio tahrirlash</h4>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="card-body py-md-30">
                <form action="{{ route('commit.update', $commit->id) }}" method="post" enctype="multipart/form-data" onsubmit="updateEditorContent()">
                    @csrf
                    @method('PUT')
                    {{-- uz --}}
                    <div class="row uz">
                        <div class="col-md-4 mb-25 my-5">
                            <label for="title_uz" class="form-label">Name</label>
                            <input type="text" id="title_uz" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="name" value="{{ $commit->name }}" placeholder="Full name">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-25">
                            ...
                            @if ($commit->image)
                                <img src="{{ asset('storage/' . $commit->image) }}" alt="Logo" class="img-fluid">
                            @endif
                        </div>
                        <div class="col-md-6">
                            <div class="layout-button mt-0">
                                <a href="{{ route('commit.index') }}" class="btn btn-default btn-squared btn-light px-20">Cancel</a>
