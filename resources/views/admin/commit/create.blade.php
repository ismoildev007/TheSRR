    ...
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="card-body py-md-30">
                <form action="{{ route('commit.store')}}" method="post" enctype="multipart/form-data" onsubmit="updateEditorContent()">
                    @csrf
                    {{-- uz --}}
                    <div class="row">
                        <div class="col-md-4 mb-25 my-5">
                            <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="name" placeholder="Full name">
                            @error('name')
                            <label for="" class="form-label text-danger"> Ism kiritish majburiy</label>
                            @enderror
                        </div>
                    </div>
