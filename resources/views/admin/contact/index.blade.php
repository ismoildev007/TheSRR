                    ...
                    <div class="col-lg-6">
                        <div class="d-none d-lg-block">
                            <ol class="breadcrumb m-0 float-end">
                                ...
                                <li class="breadcrumb-item active">Contact malumotlar</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                @foreach($contacts as $contact)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="mx-1 d-inline-block">
                                                <form action="{{ route('contact.destroy', $contact->id) }}" method="POST" onsubmit="return confirm('Ochirishga ruxsat berasizmi')">
                                                    @csrf
                                                    @method('DELETE')
