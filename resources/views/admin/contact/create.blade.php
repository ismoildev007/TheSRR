    ...
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="py-3 py-lg-4">
                <div class="row">
                    <div class="col-lg-6">
                        <h4 class="page-title mb-0">Contact malumotlar</h4>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="card-body py-md-30">
                <form action="{{ route('contact.store')}}" method="post" onsubmit="updateEditorContent()">
                    @csrf
                    {{-- uz --}}
                    <div class="row">
                        <div class="col-md-4 mb-25 my-5">
                            <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="address" placeholder="manzilni kiriting">
                        </div>
                        <div class="col-md-4 mb-25 my-5">
                            <input type="email" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="email" placeholder="Email">
                        </div>
                        <div class="col-md-4 mb-25 my-5">
                            <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="number" placeholder="Phone number">
                        </div>
                    </div>
