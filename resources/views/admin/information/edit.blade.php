    ...
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="card-body py-md-30">
                <form action="{{ route('information.update', $information->id) }}" method="post" enctype="multipart/form-data" onsubmit="updateEditorContent()">
                    @csrf
                    @method('PUT')
                    {{-- uz --}}
                    <div class="row uz">
                        <div class="col-md-4 mb-25 my-5 uz">
                            ...
                            <input type="text" id="title_uz" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="title_uz" value="{{ $information->title_uz }}" placeholder="Title UZ">
                        </div>
                        <div class="col-md-4 mb-25 my-5 ru">
                            <label for="title_ru" class="form-label">Title_ru</label>
                            <input type="text" id="title_ru" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="title_ru" value="{{ $information->title_ru }}" placeholder="Title RU">
                        </div>
                        <div class="col-md-4 mb-25 my-5 en">
                            <label for="title_en" class="form-label">Title_en</label>
                            <input type="text" id="title_en" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="title_en" value="{{ $information->title_en }}" placeholder="Title EN">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-25">
                            ...
                            @if ($information->image)
                                <img src="{{ asset('storage/' . $information->image) }}" alt="Logo" class="img-fluid">
                            @endif
                        </div>
                        <div class="col-md-6">
