                                ...
                                @foreach($posts as $info)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="mx-1 d-inline-block">
                                                <a href="{{ route('post.show', $info->id) }}"><i class="mdi mdi-eye fs-3"></i></a>
                                            </div>
                                            <div class="mx-1 d-inline-block">
                                                <form action="{{ route('post.destroy', $info->id) }}" method="POST" onsubmit="return confirm('Ochirishga ruxsat berasizmi')">
                                                    @csrf
                                                    @method('DELETE')
